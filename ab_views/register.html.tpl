		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form method="POST">
					...
					<div class="form-group {{with .errs}}{{with $errlist := index . "firstname"}}has-error{{end}}{{end}}">
						<input type="text" class="form-control" name="firstname" placeholder="First Name" value="{{.primaryIDValue}}" />
					</div>
					<div class="form-group {{with .errs}}{{with $errlist := index . "lastname"}}has-error{{end}}{{end}}">
						<input type="text" class="form-control" name="lastname" placeholder="Last Name" value="{{.primaryIDValue}}" />
					</div>
